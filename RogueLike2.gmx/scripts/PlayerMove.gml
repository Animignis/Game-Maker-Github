...
ax = x + lengthdir_x(checkDistA, direction);
ay = y + lengthdir_y(checkDistA, direction);
bx = x + lengthdir_x(checkDistA, direction + 45);
by = y + lengthdir_y(checkDistA, direction + 45);
cx = x + lengthdir_x(checkDistA, direction - 45);
cy = y + lengthdir_y(checkDistA, direction - 45);
a = CheckTile(ax, ay);
b = CheckTile(bx, by);
c = CheckTile(cx, cy);
