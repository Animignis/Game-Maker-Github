...
draw_primitive_begin(pr_trianglefan);
    ...
    draw_vertex(playerX - vx, playerY - vy);
    
    dir = point_direction(
            playerX, playerY, fx1, fy1);
    prx = playerX + lengthdir_x(len, dir);
    pry = playerY + lengthdir_y(len, dir);
